          ...
          <div v-if="totalTagPages > 1" class="mb-4 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
              <button
                ...
                :disabled="currentTagPage === 1 || tagsLoading"
              ...
              <button
                @click="nextTagPage"
                :disabled="currentTagPage === totalTagPages || tagsLoading"
                class="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Next
              </button>
          ...
          <div v-if="totalProjectPages > 1" class="mb-4 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
              <button
                ...
                :disabled="currentProjectPage === 1 || projectsLoading"
                class="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Previous
              </button>
              ...
              <button
                ...
                :disabled="currentProjectPage === totalProjectPages || projectsLoading"
                class="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Next
              </button>
...
export default {
  ...
  setup() {
    ...
    const refreshData = async () => {
      loading.value = true
      try {
        await Promise.all([loadTaxonomies(), loadTags(), loadLocalProjects()])
        clearSelection()
      } finally {
        loading.value = false
      }
    ...
    // Local methods only (no pagination - use store)
    const refreshData = async () => {
      loading.value = true
      try {
        await Promise.all([loadTaxonomies(), loadTags(), loadLocalProjects()])
    ...
    const goToTagPageLocal = (page) => {
      currentTagPage.value = page
      loadTags()
    }

    // Project pagination methods
    const prevProjectPageLocal = () => {
    ...
    const goToProjectPageLocal = (page) => {
    ...
    return {
      ...
      nextTagPageLocal,
      goToTagPageLocal,
      prevProjectPageLocal,
      nextProjectPageLocal,
      goToProjectPageLocal
    }
  }
}
</script>
